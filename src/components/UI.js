...
import { 
  IconSearch, IconChevronRight, IconCheckCircle,
...
// Card Sub-components
export const CardHeader = memo(function CardHeader({ children }) {
  return <div className="card-header">{children}</div>;
});

export const CardIcon = memo(function CardIcon({ children, subscribed = false }) {
  return <div className={`card-icon ${subscribed ? 'subscribed' : ''}`}>{children}</div>;
});

export const CardInfo = memo(function CardInfo({ children }) {
  return <div className="card-info">{children}</div>;
});

export const CardTitle = memo(function CardTitle({ children }) {
  return <div className="card-title">{children}</div>;
});

export const CardDescription = memo(function CardDescription({ children }) {
  return <div className="card-description">{children}</div>;
});

export const CardMeta = memo(function CardMeta({ children }) {
  return <div className="card-meta">{children}</div>;
});

export const CardMetaItem = memo(function CardMetaItem({ children }) {
  return <span className="card-meta-item">{children}</span>;
});

export const CardFooter = memo(function CardFooter({ children }) {
